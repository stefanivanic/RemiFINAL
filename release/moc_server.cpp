...
QT_MOC_LITERAL(11, 105, 13), // "newGroupIndex"
QT_MOC_LITERAL(12, 119, 13), // "newConnection"
QT_MOC_LITERAL(13, 133, 9), // "readyRead"
QT_MOC_LITERAL(14, 143, 12) // "disconnected"

    },
    "Server\0newMessage\0\0message\0cardThrown\0"
    "card\0groupThrown\0cards\0groupsReturned\0"
    "deckCardTaken\0talonCardTaken\0newGroupIndex\0"
    "newConnection\0readyRead\0disconnected"
};
...
void Server::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->newGroupIndex((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (Server::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Server::newGroupIndex)) {
                *result = 6;
            }
        }
    }
...
// SIGNAL 6
void Server::newGroupIndex(const QString & _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
