...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Deck_t, stringdata) + ofs \
...
const QMetaObject Deck::staticMetaObject = {
    { &CardContainer::staticMetaObject, qt_meta_stringdata_Deck.data,
...
void *Deck::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Deck.stringdata))
